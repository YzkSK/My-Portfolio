    ...
    <div className="App">
      ...
      <div className="container">
        ...
        <div className='Profile'>
          <img src="./src/Profile.jpg" alt="Profile" className='Profile-image' />
          <div className="Profile-Text">
            ...
            <div className="test">
              <Btn h="" c='btn-child' img="./src/mark-github-24.svg" name="GitHub" />
              <Btn h="" c='btn-child' img="./src/logo-black.png" name="X" />
