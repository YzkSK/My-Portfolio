...
- needsReview はデフォルト true とし、全文字を完全に正確に抽出できたという確信がある場合のみ false にする
- 少しでも不確かな文字・読み取りにくい箇所・かすれ・潰れ・フォントの崩れがある場合は needsReview を true のままにする
- 確認が完了してから初めてJSONを出力する
