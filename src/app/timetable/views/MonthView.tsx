        ...
        {cells.map((date, i) => {
          ...
          return (
            <div key={key}
              ...
              style={{ minHeight: 64, background: isTod ? 'var(--tt-tab-active-bg)' : 'var(--tt-bg-card)', border: '1px solid var(--tt-border)', borderRadius: 8, padding: '4px 5px', cursor: 'pointer', transition: 'background 0.1s' }}
